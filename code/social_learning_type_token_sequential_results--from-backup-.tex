...
{\centering \includegraphics[width=0.8\linewidth]{social_learning_type_token_sequential_results--from-backup-_files/figure-latex/plot-ratings-raw-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{social_learning_type_token_sequential_results--from-backup-_files/figure-latex/plot-difference-vs-single-raw-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{social_learning_type_token_sequential_results--from-backup-_files/figure-latex/plot-difference-high-vs-low-type-frequency-raw-1} 
